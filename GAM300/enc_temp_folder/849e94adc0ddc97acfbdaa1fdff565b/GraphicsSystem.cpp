...
void GraphicsSystem::Update(float dt)
{
	...
	for (MeshRenderer& renderer : currentScene.GetComponentsArray<MeshRenderer>())
	{
		...
		//std::cout << "Ambience : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Ambient.r << "\n";
		//std::cout << "Ambience : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Ambient.g << "\n";
		//std::cout << "Ambience : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Ambient.b << "\n";
		//std::cout << "Ambience : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Ambient.a << "\n";
		//std::cout << "\n\n";
		//std::cout << "Diffuse : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Diffuse.g << "\n";
		//std::cout << "Diffuse : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Diffuse.b << "\n";
		//std::cout << "Diffuse : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Diffuse.a << "\n";
		//std::cout << "Diffuse : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Diffuse.r << "\n";
		//std::cout << "\n\n";

		//std::cout << "Specular : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Specular.r << "\n";
		//std::cout << "Specular : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Specular.g << "\n";
		//std::cout << "Specular : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Specular.b << "\n";
		//std::cout << "Specular : " << properties[renderer.MeshName].entityMAT[properties[renderer.MeshName].iter].Specular.a << "\n";
